...
export default function InfoCard({ title, description, icon, cardClassName }: InfoCardProps) {
  return (
    <div className={`p-6 rounded-lg shadow bg-jasmine hover:transform hover:scale-105 transition-transform flex flex-col gap-2 items-center text-center w-full ${cardClassName || "max-w-sm"}`}>
      {icon}
