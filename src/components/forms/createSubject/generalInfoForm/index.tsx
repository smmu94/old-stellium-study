...
export default function GeneralInfoForm() {
  ...
  return (
    <div className="border border-oxford/50 bg-white shadow-[5px_5px_0px_#0a0f29] rounded-sm max-w-2xl h-full w-full p-6 overflow-y-auto lg:overflow-y-auto scrollbar-thin scrollbar-thumb-oxford scrollbar-track-transparent">
